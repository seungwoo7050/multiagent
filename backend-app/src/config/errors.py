...
class BaseError(Exception):
    ...
    def log_error(self, logger_instance=None):
        ...
        error_code_str = (
            self.code.value if isinstance(self.code, ErrorCode) else self.code
        )
        if self.original_error:
            logger_to_use.error(
                f"{error_code_str}: {self.message}",
                extra={"error_details": error_dict},
                exc_info=self.original_error,
            )
        else:
            logger_to_use.error(
                f"{error_code_str}: {self.message}", extra={"error_details": error_dict}
            )
...
class SystemError(BaseError):
    def __init__(
        self,
        code: Union[ErrorCode, str] = ErrorCode.SYSTEM_ERROR,
...
class APIError(BaseError):
    def __init__(
        self,
        code: Union[ErrorCode, str] = ErrorCode.API_ERROR,
...
class TaskError(BaseError):
    def __init__(
        self,
        code: Union[ErrorCode, str] = ErrorCode.TASK_ERROR,
        message: str = "A task error occurred",
        details: Optional[Dict[str, Any]] = None,
        original_error: Optional[Exception] = None,
...
class LLMError(BaseError):
    def __init__(
        self,
        code: Union[ErrorCode, str] = ErrorCode.LLM_ERROR,
...
class MemoryError(BaseError):
    def __init__(
        self,
        code: Union[ErrorCode, str] = ErrorCode.MEMORY_ERROR,
        message: str = "A memory error occurred",
        details: Optional[Dict[str, Any]] = None,
        original_error: Optional[Exception] = None,
    ):
        super().__init__(code, message, details, original_error)
...
class AgentError(BaseError):
    def __init__(
        self,
        code: Union[ErrorCode, str] = ErrorCode.AGENT_ERROR,
...
class ToolError(BaseError):
    def __init__(
        self,
        code: Union[ErrorCode, str] = ErrorCode.TOOL_ERROR,
...
class OrchestrationError(BaseError):
    def __init__(
        self,
        code: Union[ErrorCode, str] = ErrorCode.ORCHESTRATION_ERROR,
        message: str = "An orchestration error occurred",
        details: Optional[Dict[str, Any]] = None,
        original_error: Optional[Exception] = None,
    ):
        super().__init__(code, message, details, original_error)
...
class ConnectionError(BaseError):
    def __init__(
        self,
        code: Union[ErrorCode, str] = ErrorCode.CONNECTION_ERROR,
        message: str = "A connection error occurred",
        details: Optional[Dict[str, Any]] = None,
        original_error: Optional[Exception] = None,
...
ERROR_CLASS_REGISTRY: Dict[ErrorCode, Type[BaseError]] = {
    ErrorCode.SYSTEM_ERROR: SystemError,
    ErrorCode.CONFIG_ERROR: SystemError,
    ErrorCode.INITIALIZATION_ERROR: SystemError,
    ErrorCode.SHUTDOWN_ERROR: SystemError,
    ErrorCode.API_ERROR: APIError,
    ErrorCode.VALIDATION_ERROR: ValidationError,
    ErrorCode.AUTHENTICATION_ERROR: APIError,
    ErrorCode.AUTHORIZATION_ERROR: APIError,
    ErrorCode.RATE_LIMIT_ERROR: APIError,
    ErrorCode.ENDPOINT_NOT_FOUND: NotFoundError,
    ErrorCode.BAD_REQUEST: APIError,
    ErrorCode.TASK_ERROR: TaskError,
    ErrorCode.TASK_NOT_FOUND: TaskError,
    ErrorCode.TASK_CREATION_ERROR: TaskError,
    ErrorCode.TASK_EXECUTION_ERROR: TaskError,
    ErrorCode.TASK_TIMEOUT: TaskError,
    ErrorCode.TASK_CANCELED: TaskError,
    ErrorCode.LLM_ERROR: LLMError,
    ErrorCode.LLM_API_ERROR: LLMError,
    ErrorCode.LLM_TIMEOUT: LLMError,
    ErrorCode.LLM_RATE_LIMIT: LLMError,
    ErrorCode.LLM_CONTENT_FILTER: LLMError,
    ErrorCode.LLM_CONTEXT_LIMIT: LLMError,
    ErrorCode.LLM_TOKEN_LIMIT: LLMError,
    ErrorCode.LLM_PROVIDER_ERROR: LLMError,
    ErrorCode.MEMORY_ERROR: MemoryError,
    ErrorCode.REDIS_CONNECTION_ERROR: MemoryError,
    ErrorCode.REDIS_OPERATION_ERROR: MemoryError,
    ErrorCode.MEMORY_RETRIEVAL_ERROR: MemoryError,
    ErrorCode.MEMORY_STORAGE_ERROR: MemoryError,
    ErrorCode.VECTOR_DB_ERROR: MemoryError,
    ErrorCode.AGENT_ERROR: AgentError,
    ErrorCode.AGENT_NOT_FOUND: AgentError,
    ErrorCode.AGENT_CREATION_ERROR: AgentError,
    ErrorCode.AGENT_EXECUTION_ERROR: AgentError,
    ErrorCode.AGENT_TIMEOUT: AgentError,
    ErrorCode.TOOL_ERROR: ToolError,
    ErrorCode.TOOL_NOT_FOUND: ToolError,
    ErrorCode.TOOL_EXECUTION_ERROR: ToolError,
    ErrorCode.TOOL_TIMEOUT: ToolError,
    ErrorCode.TOOL_VALIDATION_ERROR: ToolError,
    ...
    ErrorCode.WORKER_ERROR: OrchestrationError,
    ErrorCode.CIRCUIT_BREAKER_OPEN: OrchestrationError,
    ErrorCode.CONNECTION_ERROR: ConnectionError,
    ErrorCode.HTTP_ERROR: ConnectionError,
    ErrorCode.NETWORK_ERROR: ConnectionError,
    ErrorCode.TIMEOUT_ERROR: ConnectionError,
}
...
def create_error_from_code(
    ...
    **kwargs,
    ...
    if error_class == ValidationError:
        return error_class(
            message=message, details=details, original_error=original_error
        )
...
def convert_exception(
    ...
    return create_error_from_code(
        code=default_code, message=message, original_error=exception
    )
...
ERROR_TO_HTTP_STATUS = {
    ...
    ErrorCode.LLM_CONTENT_FILTER: 451,
}
